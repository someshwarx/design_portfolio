...
export default function AboutContent() {
    return (
        <motion.section
            ...
            initial="hidden"
            animate="show"
            className="relative z-10 pt-40 px-6 md:px-20 max-w-7xl mx-auto flex flex-col gap-16 pb-20"
        >
            {/* Intro / Hero of About */}
            <motion.div variants={item} className="space-y-6">
                <h1 className={cn("text-5xl md:text-7xl lg:text-[8vw] font-bold uppercase leading-[0.9] text-[#F0F0F0]", syne.className)}>
                    Architect<br /> of Digital<br /> <span className="text-red-600">Chaos.</span>
                </h1>
                <div className="font-mono text-neutral-400 max-w-2xl text-sm md:text-base leading-relaxed tracking-wide space-y-4">
            ...
            <motion.div variants={item} className="grid grid-cols-1 md:grid-cols-2 gap-12 border-t border-white/10 pt-12">
                <div className="space-y-4">
                    <h3 className={cn("text-2xl font-bold uppercase", syne.className)}>The Philosophy</h3>
                    <div className="font-mono text-neutral-400 text-sm leading-relaxed space-y-4">
                ...
                <div className="space-y-4">
                    <h3 className={cn("text-2xl font-bold uppercase", syne.className)}>The Approach</h3>
                    <div className="font-mono text-neutral-400 text-sm leading-relaxed space-y-4">
            ...
            <motion.div variants={item} className="border-t border-white/10 pt-20 pb-10 text-center">
                <h2 className={cn("text-4xl md:text-6xl font-bold uppercase mb-6", syne.className)}>
                    Ready to <span className="text-red-600">Collaborate?</span>
                </h2>
                <a href="mailto:someshwark22@gmail.com" className="inline-block border border-white/20 px-8 py-4 font-mono text-sm uppercase tracking-widest hover:bg-white hover:text-black transition-all">
                    Start a Project
                </a>
            </motion.div>
        </motion.section>
